#ifndef FUNCTION_4_UPDATE_H
#define FUNCTION_4_UPDATE_H
...
int rm_BlankLine2(string file){// 删除文本空行
...
string CharToStr2(char * contentChar)// 辅助删除函数
{
    string tempStr;
...
void Delete_items2(string ID) { // 删除物品
  /* Preparation */
  ifstream file0;
...
public:
  Library() {}
  ~Library() {}
  void updateItems(string s1, string s2, string s3, string s4, string s5, string s6, string Del);
};

void Library:: updateItems(string s1, string s2, string s3, string s4, string s5, string s6, string Del) {
  /* Preparation */
  ifstream file0;
  file0.open("Parameter.txt");
  string order;
